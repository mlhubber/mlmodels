...
This pre-built model uses Python's *keras* package to build a convolutional 
...
performance of the model in terms of accuracy, and confusion matrix. 
The model using feature extraction with a pretrained network results in an accuracy of 87%.
